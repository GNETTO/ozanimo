...
CREATE TABLE `animalerie`.`collaborateur` ( `id` INT(10) NOT NULL AUTO_INCREMENT , `email` VARCHAR(100) NULL , `pass` VARCHAR(100) NULL , `name` VARCHAR(100) NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;